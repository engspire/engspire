  ...
  return (
    <>
      ...
      <div className="form-control">
        ...
        <input type="text" placeholder="kasunudaharana@gmail.com" className="input input-bordered" value={emailAddress} disabled={profile?.emailAddress ? true : false} onChange={e => updateFields({ emailAddress: e.target.value })} />
      </div>
      <div className="form-control">
        <label className="label">
