        ...
        {showJoin && (
          <div className="card-actions justify-end mt-4">
            ...
            {data.canRegister && data.registrationUrl
              ? profile?.emailAddress ? <Link target="_blank" href={data.registrationUrl} className="btn btn-primary btn-block" >Sign up</Link> : <Link target="_blank" href={data.registrationUrl} className="btn btn-primary btn-block" >Sign up</Link>
              : profile?.emailAddress ? <Link target="_blank" href={data.registrationUrl} className="btn btn-accent btn-block" >Join the waiting list</Link> : <Link target="_blank" href={data.registrationUrl} className="btn btn-accent btn-block" >Join the waiting list</Link>}
          </div>
        )}
      </div>
    </div>
