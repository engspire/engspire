      ...
      <div className="card-body">
        ...
        {showJoin && (
          <div className="card-actions justify-end mt-4">
            ...
            {data.canRegister && data.registrationUrl ? <Link href={data.registrationUrl} className="btn btn-primary btn-block" >Sign up</Link> : <Link href={data.registrationUrl} className="btn btn-info btn-block" >Pre-register</Link>}
          </div>
        )}
      </div>
    </div>
