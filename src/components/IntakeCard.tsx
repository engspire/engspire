        ...
        {showJoin && (
          <div className="card-actions justify-end mt-4">
            ...
            {data.canRegister && data.registrationUrl
              ? profile?.emailAddress ? <Link target="_blank" href={data.registrationUrl} className="btn btn-primary btn-block" >Sign up</Link> : <Link target="_blank" href={data.registrationUrl} className="btn btn-secondary btn-block" >Sign up</Link>
              : profile?.emailAddress ? <Link target="_blank" href={data.registrationUrl} className="btn btn-accent btn-block" >Pre-register</Link> : <Link target="_blank" href={data.registrationUrl} className="btn btn-info btn-block" >Pre-register</Link>}
          </div>
        )}
      </div>
    </div>
